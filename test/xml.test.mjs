...
test('stripHtml produces readable plain text and double-decodes', () => {
  ...
  assert.equal(stripHtml('<a href="https://example.com/downloads">View downloads</a>'), 'View downloads');
  assert.equal(stripHtml('<p>Read the <a href="https://example.com/releases">View release notes</a>.</p>'), 'Read the View release notes.');
